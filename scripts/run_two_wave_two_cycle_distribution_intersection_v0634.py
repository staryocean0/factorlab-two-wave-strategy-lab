#!/usr/bin/env python3
"""Formal v0.6.34 two-cycle distribution intersection Range replay."""
...
from factor_lab.visual_structure.two_wave.d1_two_cycle_distribution_intersection_v0634 import (
    d1_primary_two_cycle_distribution_range_rescue,
)
...
def state(row, bars, closes, view):
    ...
    out = d1_primary_two_cycle_distribution_range_rescue(
        d1,
        closes,
    ...
    return {
        ...
        "all_supports_distribution_pass": out.get("all_supports_distribution_pass"),
    }


def write_card(path: Path, result: dict) -> None:
    b = result["pooled"]["v0625"]
    c = result["pooled"]["v0634"]
    lines = [
        "# Two-Wave v0.6.34 two-cycle distribution intersection result",
        "",
...
def main() -> None:
    ...
    for view in VIEWS[1:]:
        ...
        per_offset[view] = {"v0625": metrics(old_pairs), "v0634": metrics(new_pairs)}
    ...
    gates = {
        ...
        "all_offsets_exact_nonworse_vs_v0625": all(
            r["v0634"]["exact_agreement"] >= r["v0625"]["exact_agreement"]
    ...
    result = {
        "schema": "two_wave_two_cycle_distribution_intersection_result@0.6.34",
        "verdict": "v0634_two_cycle_distribution_intersection_direction_research_component_pass"
        if passed
        else "v0634_two_cycle_distribution_intersection_direction_rejected",
        "controls": {
        ...
        "audit": {
            ...
            "minimum_iqr_overlap": 0.50,
            "all_four_supports_required": True,
        },
        "pooled": {"v0625": old, "v0634": cand},
